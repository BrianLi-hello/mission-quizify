        ...
        with screen.container():
            ...
            st.markdown("""
                <div style='display: flex; justify-content: left; padding: 10px'>
                    <a href="https://github.com/BrianLi-hello/mission-quizify" target="_blank">
                        <img src="https://badgen.net/badge/icon/GitHub?icon=github&label" alt="GitHub" style="margin-right: 10px;">
                    </a>
                    <a href="https://www.linkedin.com/in/brian-li-ucd/" target="_blank">
                        <img src="https://img.shields.io/badge/LinkedIn-Profile-blue?logo=linkedin&style=flat-square" alt="LinkedIn">
                    </a>
                </div>
